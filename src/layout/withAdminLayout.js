          ...
          <Layout className="layout">
            ...
            >
              <div className="flex  flex-row items-center flex-1 h-full">
                <div
                  className={` rtl:ssm:pr-[15px]    bg-primary ltr:pr-5 rtl:pl-5 ltr:ssm:pl-[15px] ltr:ssm:pr-[15px] rtl:ssm::pl:[15px] ltr:pl-[30px] rtl:pr-[30px] xs:ltr:pl-[20px] xs:rtl:pr-[20px] ${
                    !collapsed ? "w-[280px]" : "w-20 transition-all"
                  }  ssm:min-w-[220px] xs:min-w-[170px] h-full grid align-middle dark:bg-[#323541] `}
                >
                    ...
                    {!collapsed ? (
                      <Link to="/admin">
                        <img
                          ...
                          className="w-full max-w-[190px] xs:max-w-[200px]"
                          src={
